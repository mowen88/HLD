...
class Camera(pygame.sprite.Group):
	...
	def offset_draw(self, target):
		...
		self.offset.x += (target.rect.centerx - HALF_WIDTH - (HALF_WIDTH - pygame.mouse.get_pos()[0])/4 - self.offset.x)/120
		self.offset.y += (target.rect.centery - HALF_HEIGHT - (HALF_HEIGHT - pygame.mouse.get_pos()[1])/4 - self.offset.y)/120
